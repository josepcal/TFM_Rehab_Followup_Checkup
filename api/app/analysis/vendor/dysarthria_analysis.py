# Vendored upstream snapshot for FTM UC4 sustained-phonation analysis.
# Attribution/licensing: approved for vendoring by Task 1.1; keep this module
# behaviourally identical to the approved source. FTM-specific integration must
# live in adapter code, not in this vendored snapshot.
